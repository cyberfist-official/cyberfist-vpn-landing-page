...
export default function Home() {
  ...
  const [waitlistSource, setWaitlistSource] = useState<string>("hero_button");
      ...
      <div className="bg-dark-bg rounded-3xl max-w-4xl mx-auto my-8 p-6 sm:p-12 md:p-16 text-light-text font-sans shadow-2xl shadow-black/50 relative overflow-hidden">
        ...
        <section className="mb-12 md:mb-16">
          ...
          <p className="text-lg md:text-xl text-dark-text mb-8 max-w-xl">
            A fast, secure VPN and privacy platform that puts control back in
            your hands.
          </p>
          ...
          <button
            type="button"
            onClick={() => openWaitlist("hero_button")}
            className="inline-flex items-center justify-center rounded-lg bg-emerald-500 px-6 py-2.5 text-sm font-semibold text-slate-950 shadow-lg shadow-emerald-500/30 hover:bg-emerald-400 transition"
          >
            Join the waitlist
          </button>
          ...
          <div className="space-y-4 text-dark-text max-w-2xl text-base md:text-lg mt-12">
            <p>
              Every click, every search, every login is tracked. Big tech
              profits from your data. Hackers look for your weakest link.
            </p>
            <p>
        ...
        <section className="my-16 md:my-20">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {featuresData.map((feature) => (
              ...
              >
                <div className="mb-4 text-accent-teal h-8 w-8">
                  {feature.icon}
                </div>
        ...
        <footer className="border-t border-[#1E4247]/40 pt-10 mt-16 text-center">
          <div className="flex flex-col items-center gap-6">
            ...
            <button
              type="button"
              onClick={() => openWaitlist("footer_button")}
              className="inline-flex items-center justify-center rounded-lg bg-emerald-500 px-6 py-2.5 text-sm font-semibold text-slate-950 shadow-lg shadow-emerald-500/30 hover:bg-emerald-400 transition"
            >
              Join the waitlist
            </button>
